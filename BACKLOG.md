...
| # | Statut | Quoi | Notes |
|---|--------|------|-------|
| P1 | doing | Liens vers les documents cités + liste des sources | Chaque article a déjà son lien Légifrance/Fedlex. À faire : les références de chapitre (« L1233-1 → L1233-91 ») cliquables, section « Sources » complète avec dates d'état des textes. |
| P2 | doing | Transparence : site apolitique, fait par un citoyen avec l'IA Claude | Une mention en tête et dans « Méthode et limites ». |
...
| P4 | doing | Export PDF / lecture hors ligne | Étape 1 : feuille de style d'impression + bouton « Télécharger en PDF » (impression navigateur, tous les textes dépliés). Étape 2 : PDF généré au build pour téléchargement direct. |
...
| P6 | todo | Déploiement public sur Vercel | Preview via le connecteur ; passage en production quand P2 et P5 sont faits. Nom de domaine à choisir. |
