...
# ---- topic sections ----
# Première partie > Livre II : Le contrat de travail
#   Titre IV : Contrat de travail à durée déterminée (L1241-L1248 / R,D1242-1248)
#   Titre V   : Contrat de travail temporaire, autres contrats de mise à disposition
#               et portage salarial (L1251-L1255 / R,D1251-1255)
LEG_TITRE_IV = "LEGISCTA000006160711"
LEG_TITRE_V = "LEGISCTA000030442282"
REG_TITRE_IV = "LEGISCTA000018537464"
REG_TITRE_V = "LEGISCTA000031818235"

# Out of scope but noted in report: Titre VI (salariés détachés temporairement,
# LEGISCTA000006160713 / LEGISCTA000018537158) and Titre VII (chèques et titres
# simplifiés de travail, LEGISCTA000006160714 / LEGISCTA000018537060) -- not
# part of the CDD/intérim topic, excluded from ALLOWED_PREFIXES below.

ALLOWED_PREFIXES = {"1241", "1242", "1243", "1244", "1245", "1246", "1247", "1248",
...
leg_node_titre_iv = find(root, LEG_TITRE_IV)
leg_node_titre_v = find(root, LEG_TITRE_V)
reg_node_titre_iv = find(root, REG_TITRE_IV)
reg_node_titre_v = find(root, REG_TITRE_V)

BOOK_PATH = ["Première partie : Les relations individuelles de travail",
             "Livre II : Le contrat de travail"]

leg_sections = (
    collect_sections_from_children(leg_node_titre_iv, BOOK_PATH + ["Titre IV : Contrat de travail à durée déterminée"])
    + collect_sections_from_children(leg_node_titre_v, BOOK_PATH + ["Titre V : Contrat de travail temporaire, autres contrats de mise à disposition et portage salarial"])
)
reg_sections = (
    collect_sections_from_children(reg_node_titre_iv, BOOK_PATH + ["Titre IV : Contrat de travail à durée déterminée"])
    + collect_sections_from_children(reg_node_titre_v, BOOK_PATH + ["Titre V : Contrat de travail temporaire, autres contrats de mise à disposition et portage salarial"])
)
...
output = {
    ...
    "topic": "CDD, intérim et mise à disposition",
    "code_totals": {
        "articles_L": code_L,
        "articles_R": code_R,
        "articles_D": code_D,
...
OUT = "/Users/joachimndoye/alleger-le-code/data/fr_cdd.json"
